...
?>
  ...
  <head>
            ...
            $.ajax({
                        ...
                        success:function(data){
                                 ...
                                 var markup= "<tr><td><center>"+challan["challanNo"]+"</center></td>"
                                            ...
                                            +"<td><center><a href='"+challan["LR_LOC"]+"'>"+challan["LR"]+"-"+challan["transportParcels"]+"-"+challan["transportName"]+"</a></center></td>"
                                            +"<td><center><a href='"+challan["BILL_LOC"]+"'>"+challan["billID"]+"</a></center></td>"
                                            +"<td><center><button type='submit' class='updateChallan' value='"+challan["challanNo"]+"'>UPDATE</button><center></td>"
                                            +"<td><center><button type='submit' class='generateBill' value='"+challan["challanNo"]+"'>Generate Bill</button><center></td>";
	...
	<tr><th>CHALLAN ID </th><th> ******DATE****** </th><th>COMPANY NAME </th><th>**QUANTITY**</th><th>**BOOKING DATE**</th><th>TRANSPORT--LR--PARCELS </th><th>**BILL ID ***</th><th>UPDATE CHALLAN</th><th>GENERATE BILL</th><th>SEND</th></tr>
