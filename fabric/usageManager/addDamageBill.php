...
<?php
  ...
  <head>
	...
	<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$("#addDamageBillButton").click(function(){
					...
					if(!isNaN($("#damageMeterText").val()) && $("#damageMeterText").val()!=""){
					
					var bill_id=$("#billListDrop").val();
					var damageMeter=$("#damageMeterText").val();
					
					var action="addDamageBill";
					...
					if($('#file').get(0).files.length > 0 ){
							...
							if(($('#file')[0].files[0].size)/1000 < 20000){
								...
								fd.append('damageMeter',damageMeter);
	...
	<h3 align='center'>ADD Damage Bill</h3>
	...
	<div class="damageDetails" id="damageDetails" style="display:none;">
	
	
	
	DAMAGE METERS <input type="text" id="damageMeterText" name="damageMeterText" inputmode="decimal"  >
    ...
    <form method="post" action="" enctype="multipart/form-data" id="myform">
        ...
        <div >
			...
			<input type="button" class="buttonFile" value="Upload" id="addDamageBillButton"> 
