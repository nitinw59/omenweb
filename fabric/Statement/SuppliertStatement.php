		...
		$(document).ready(function() {
			...
			var webdir = <?php echo json_encode($omenNX); ?>;
					...
					$.ajax({
						...
						$.each(bills_list, function( index, bill ) {
							...
							if(i<=0){
								...
								var markup= "<tr><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center><span class='label1 warning'>"+old_balance+"</span></center></td></tr>";
							
								$("#bills_tbl tbody").append(markup);
							...
							if(Number(bill["PAYMENT AMOUNT"])<Number(bill["BILL AMOUNT"])){
									markup= "<tr><td><center>"+bill["BILL ID"]+"</center></td><td><center>"+bill["DATE"]+"</center></td><td><center><a href='/data/"+webdir+"/fabric/bills/"+bill["loc"]+"'>invoice</a></center></td><td><center>"+bill["ITEM_QUANTITY"]+"</center></td><td><center>"+bill["ITEM_RATE"]+"</center></td><td><center>"+bill["BILL AMOUNT"]+"</center></td>"
											...
											+"<td><center>"+(0+Number(bill["BILL AMOUNT"])- Number(bill["PAYMENT AMOUNT"]))+"</center></td><td><center>"+(balance)+"</center></td></tr>";
							}else{
									markup= "<tr><td><center>"+bill["BILL ID"]+"</center></td><td><center>"+bill["DATE"]+"</center></td><td><center><a href='/data/"+webdir+"/fabric/bills/"+bill["loc"]+"'>invoice</a></center></td><td><center>"+bill["ITEM_QUANTITY"]+"</center></td><td><center>"+bill["ITEM_RATE"]+"</center></td><td><center>"+bill["BILL AMOUNT"]+"</center></td>"
						...
						var markup= "<tr><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center>-</center></td><td><center><span class='label1 success' id='availableCredits'>"+credits+"</span></center></td></tr>";
							
						$("#bills_tbl  tbody").append(markup);
							
						
						var markup= "<tr><td colspan='2'><center>Total Bills:"+counter+"</center></td><td><center></center></td><td colspan='3'><center>Total Balance till date: "+to_date+"</center></td><td><center></center></td><td><center></center></td><td><center><span class='label1 danger'>"+(balance-credits)+"</span></center></td></tr>"
				...
				$("#showAllBills").click(function(){
					alert("heh");
					window.open("SupplierBillStatement.php");
...
include($_SERVER['DOCUMENT_ROOT']."/$omenNX/index.php");
	...
	<table id="bills_tbl" class="fixed_bills_statement_tbl">
		<thead>
			<tr><th>BILL ID </th><th >******DATE****** </th><th>Loc</th><th>**BILL ITEMS**</th><th>**RATE**</th><th>BILL_AMOUNT </th><th>****PAYMENT**** </th><th>****PENDING**** </th><th>TOTAL BALANCE </th></tr>
		</thead>
		<tbody>
		</tbody>
	</table>
