...
<?php
  ...
  <head>
			...
			var buyernameArray = <?php echo json_encode($customercompanynames); ?>;
				...
				$("#showPayments").click(function(){
					...
					$.ajax({
                        ...
                        data:"from_date="+from_date+"&to_date="+to_date+"&action=listAllPayment",
                        success:function(data){
						$("#paymentdetail").show();
						var payments_list = JSON.parse(data);
								$.each(payments_list, function( index, payment ) {
									var markup= "<tr id='"+payment["credits_id"]+"'><td><center>"+payment["date"]+"</center></td><td><center>"+payment["COMPANY_NAME"]+"</center></td><td><center>"+payment["amount"]+"</center></td><td><center>"+payment["DESCRIPTION"]+"</center></td><td><center><button class='delete' value='"+payment["credits_id"]+"'>delete</button></center></td></tr>"
	...
	<center><h3>List All Credits</h3></center>
	...
	<span class="label info" id="totalamountlabel">Info</span><br></br>
	<table id="payments_tbl">
	<tr><th>DATE </th><th>COMPANY_NAME </th><th>AMOUNT </th><th>Remark </th><th>Delete </th></tr>
