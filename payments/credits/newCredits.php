  ...
  <head>
	...
	<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				var remark_amount = <?php echo json_encode($remark_amount_VALUES); ?>;
				$("#remark_amount").select2({
				  data: remark_amount
				});
				...
				$("#remark_amount").change(function(){
					
          if($("#remark_amount").val()=="OTHER"){
            $("#other").show();
            $("#other_label").show();
          }
...
$current_date=date('Y-m-d', time());
	...
	Remark <select id="remark_amount" style="width:300px;">
	<!-- Dropdown List Option -->
			</select>
      <br></br>
	<label id="other_label" style="display:none;">
    OTHER <input type="text" id="other" name="other" style="display:none;" >
    </label>
